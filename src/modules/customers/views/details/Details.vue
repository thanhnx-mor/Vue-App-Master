...
<template>
  <div>
    <div class="body-upper">
      ...
      <div class="actions">
        <template v-if="hasPermission([PERMISSION.CUSTOMER['*'], PERMISSION.CUSTOMER.DESTROY])">
          <b-button
        ...
        <template v-if="!isLoading">
          <template v-if="hasPermission([PERMISSION.DEAL['*'], PERMISSION.DEAL.STORE])">
            <b-button v-b-modal.dealCreateModal class="ml-2 nt_btn nt_btn-warning nt-button-top">
          ...
          <template v-else>
            <b-button
              class="ml-2 nt_btn nt_btn-warning nt-button-top permission-btn-disabled"
              v-b-tooltip.hover
              :title="messageNotPermission"
            >
              <i class="fas fa-plus mr-2"></i>
              ...
              <template v-for="(attribute, index) in customer.attributes">
                <div class="col-sm-6 pt-2 pb-2" :key="index" v-if="attribute.is_enabled">
                  <div
                    ...
                    style="margin: 0px;"
                    :class="[
                    attribute.slug === 'ma_kh' ? 'nt-attribute-item-disabled' : '', 
