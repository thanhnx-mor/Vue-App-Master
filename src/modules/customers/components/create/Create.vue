...
<template>
  <div>
    <template v-if="hasPermission([PERMISSION.CUSTOMER['*'], PERMISSION.CUSTOMER.STORE])">
      <b-button v-b-modal.customerCreateModal class="nt_btn nt_btn-warning nt-button-top">
