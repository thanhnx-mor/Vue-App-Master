...
<template>
  <div>
    <b-modal
      ...
      modal-class="modal-footer-custom modal-deal"
            ...
            <b-collapse visible id="dealInfo" class="w-100">
              <div class="row mt-3">
                ...
                <div class="col-md-3">
                  ...
                  >
                    <b-form-group
                      id="deal-workflow_id-group"
                      label="Quy trình làm việc"
                      label-for="deal-workflow_id"
                      label-class="required"
                    >
                      <multiselect
                        :class="{ 'is-invalid': validationContext.errors[0] || (serverErrors && serverErrors['workflow_id']) }"
                        :name="'deal-workflow_id'"
                        :options="dealWorkflows"
                        ...
                        trackBy="id"
                        v-model="deal.workflow_id"
                        :showLabels="false"
                      ></multiselect>
                      <b-form-invalid-feedback
                        v-if="serverErrors && serverErrors['workflow_id']"
                        id="deal-workflow_id-group-feedback"
              ...
              <validation-observer ref="validationObserver" class="w-100">
                ...
                >
                  ...
                  <template v-slot:cell(customer)="data">
                    ...
                    <!-- :aria-describedby="'customer' + data.index + '-group-feedback'"
                        :class="{ 'is-invalid': validationContext.errors[0]  }"
                      <b-form-invalid-feedback
                        :id="'customer' + data.index + '-group-feedback'"
                      >{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                    </validation-provider>-->
                  </template>
