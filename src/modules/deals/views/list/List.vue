            ...
            <div class="col-md-6 mb-4">
              <template v-if="items.length > 0">
                <b-dropdown
                  ...
                  class="actions"
                >
                  <template v-if="hasPermission([PERMISSION.DEAL['*'], PERMISSION.DEAL.EXPORT])">
                    <b-overlay
                      rounded
                      opacity="0.6"
                      spinner-small
          ...
          <template>
            ...
            >
              ...
              <template v-slot:cell(ma_dh)="data">
                <template v-if="hasPermission([PERMISSION.DEAL['*'], PERMISSION.DEAL.SHOW])">
                  <router-link
                    :to="{ name: PERMISSION.DEAL.SHOW, params: { id: data.item.id } }"
